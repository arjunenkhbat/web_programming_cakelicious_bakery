...
app.get("/about", (req, res) => {
  res.sendFile("app/aboutUs.html", { root: __dirname });
});
//services hsesg
app.get("/train", (req, res) => {
  res.sendFile("app/train.html", { root: __dirname });
});
app.get("/special", (req, res) => {
  res.sendFile("app/special.html", { root: __dirname });
});
app.get("/cart", (req, res) => {
  res.sendFile("app/cart.html", { root: __dirname });
});
app.get("/cake", (req, res) => {
  res.sendFile("app/cake1.html", { root: __dirname });
});
